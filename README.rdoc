...
Creates HTML tags for opening and closing containing some content.
  ...
  # return <p class="class-name">content for tag</p>
...
- With complete URL
    ...
    $html->image('/picture.png', array('title' => 'Sample picture'), true);
    # return <img alt="" title="Sample picture" src="http://domain.com/images/picture.png">

- With incomplete URL

    $html->image('/picture.png', array('title' => 'Sample picture'));
    # return <img alt="" title="Sample picture" src="/images/picture.png">

- With remote URL

    $html->image('http://google.com/logo.png', array('title' => 'Google picture'));
    # return <img alt="" title="Google picture" src="http://google.com/logo.png">
...
Creates sheet elements style for use in HTML.
  ...
  # return <link href="/styles/screen.css" rel="stylesheet" type="text/css" />
...
Creates a script element to be used in HTML.
  ...
  # return <script src="/scripts/jquery.js" type="text/javascript"></script>
