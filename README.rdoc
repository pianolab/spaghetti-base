...
- With complete URL
    ...
    # return <figure><img alt="Google picture" title="Google picture" src="http://google.com/logo.png"></figure>

- With incomplete URL

    $html->image('/picture.png', array('alt' => 'Sample picture'));
    # return <figure><img alt="Sample picture" title="Sample picture" src="/images/picture.png"></figure>
...
- Without figure
    ...
    # return <img alt="Google picture" title="Google picture" src="http://google.com/logo.png">
