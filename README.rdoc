...
@param +string+ $tag Tag to be created <br />
@param +string+ $content Content between the tags inserted <br />
@param +array+ $attr Tag's attributes <br />
@param +boolean+ $empty True to create an empty tag <br />
@return +string+ HTML tag with its contents <br />
